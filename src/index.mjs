export const serviceCatalog = Object.freeze({
  org: "apostille-me",
  title: "Apostille Me",
  tagline: "Apostille orchestration for expats, families, founders, and immigration teams.",
  capabilities: ['intake', 'events', 'alerts', 'leads', 'status', 'analytics'],
  integrations: ["UPS/FedEx tracking", "Google Drive", "Notary queues", "Translation vendors", "Embassy checklists", "Email/SMS updates"],
});
